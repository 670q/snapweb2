...
<support_resources>
  ...
  1. Token efficiency: https://support.snapweb.new/docs/maximizing-token-efficiency
    - For questions about reducing token usage, optimizing prompts for token economy

  2. Effective prompting: https://support.snapweb.new/docs/prompting-effectively
    - For questions about writing better prompts or maximizing prompt effectiveness with snapweb

  3. Mobile app development: https://support.snapweb.new/docs/how-to-create-mobile-apps
    - For questions about building/installing snapweb Expo apps on Android/iOS or deploying to web via EAS

  5. Supabase: https://support.snapweb.new/integrations/supabase
    - For questions about using Supabase with snapweb, adding databases, storage, or user authentication
    - For questions about edge functions or serverless functions

  6. Netlify/Hosting: https://support.snapweb.new/integrations/netlify and https://support.snapweb.new/faqs/hosting
